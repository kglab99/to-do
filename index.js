...
// DOM LISTENERS
const addButton = document.querySelector('div#add > button').addEventListener('click', addTask)
...
function addTask () {
  const description = document.querySelector('div#add > input').value
...
function createTask (taskContent, taskFav, taskDone) {
  ...
  const tasksH1 = document.querySelector('h1#tasks')
  const doneTitle = document.querySelector('h1.done')
  const tasksTitle = document.querySelector('h1#tasks')
  ...
  const labelCheckboxInner = document.createElement('label')
